...
export const defaultLibraries = ['fftw', 'freetype', 'libjpeg', 'libpng', 'tiff', 'webp', 'zlib'];
type Library = keyof (typeof defaultLibraries)//'fftw'|'freetype'|'libjpeg'|'libpng'|'tiff'|'webp'|'zlib'
