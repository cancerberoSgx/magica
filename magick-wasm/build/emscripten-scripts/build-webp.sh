...
emconfigure cmake ../ -DCMAKE_INSTALL_PREFIX=$PREFIX -DCMAKE_BUILD_TYPE=Release \
  -DCMAKE_C_FLAGS="$CFLAGS -s ERROR_ON_UNDEFINED_SYMBOLS=0" -DCMAKE_LIBRARY_PATH="$PREFIX/lib" -DWEBP_ENABLE_SIMD=off  -DENABLE_SHARED=off \
  -DWEBP_BUILD_ANIM_UTILS=off -DWEBP_BUILD_CWEBP=off -DWEBP_BUILD_DWEBP=off -DWEBP_BUILD_GIF2WEBP=off -DWEBP_BUILD_IMG2WEBP=off \
  -DWEBP_BUILD_VWEBP=off -DWEBP_BUILD_WEBPINFO=off -DWEBP_BUILD_EXTRAS=off -DWEBP_BUILD_WEBPDEMUX=off -DWEBP_BUILD_WEBPMUX=on \
