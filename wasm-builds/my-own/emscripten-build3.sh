...
emconfigure ./configure \
  ...
  --disable-largefile --disable-openmp --without-bzlib --without-dps --without-webp  \
  ...
  --with-zlib --with-jp2=yes --with-jpeg=yes --with-png --with-freetype \
...
./libtool --tag=CC --mode=link emcc $LDFLAGS $CFLAGS --pre-js "$PREFIX/wasm/pre-js.js" -o $PREFIX/wasm/magick.html utilities/magick.o $PREFIX/lib/libMagickCore-7.Q8HDRI.a $PREFIX/lib/libMagickWand-7.Q8HDRI.a $HOME/.emscripten_cache/asmjs/libz.a  $HOME/.emscripten_cache/asmjs/libfreetype.a $HOME/.emscripten_cache/asmjs/libjpeg.bc $HOME/.emscripten_cache/asmjs/libpng.bc 
