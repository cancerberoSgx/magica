[magica](../README.md) › ["types"](../modules/_types_.md) › [CliOptions](_types_.clioptions.md)
...
*Defined in [types.ts:122](https://github.com/cancerberoSgx/magica/blob/19bf60b/src/types.ts#L122)*
...
*Defined in [types.ts:123](https://github.com/cancerberoSgx/magica/blob/19bf60b/src/types.ts#L123)*
