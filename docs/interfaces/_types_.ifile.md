...
*Defined in [types.ts:16](https://github.com/cancerberoSgx/magica/blob/cc19f3a/src/types.ts#L16)*
...
*Defined in [types.ts:11](https://github.com/cancerberoSgx/magica/blob/cc19f3a/src/types.ts#L11)*
