...
*Defined in [image/imageCompare.ts:8](https://github.com/cancerberoSgx/magica/blob/99a018b/src/image/imageCompare.ts#L8)*
...
*Defined in [image/imageCompare.ts:16](https://github.com/cancerberoSgx/magica/blob/99a018b/src/image/imageCompare.ts#L16)*
