...
*Defined in [image/imageCompare.ts:8](https://github.com/cancerberoSgx/magica/blob/c6ded1a/src/image/imageCompare.ts#L8)*
...
*Defined in [image/imageCompare.ts:16](https://github.com/cancerberoSgx/magica/blob/c6ded1a/src/image/imageCompare.ts#L16)*
