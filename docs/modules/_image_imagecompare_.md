...
*Defined in [image/imageCompare.ts:8](https://github.com/cancerberoSgx/magica/blob/5e806b9/src/image/imageCompare.ts#L8)*
...
*Defined in [image/imageCompare.ts:16](https://github.com/cancerberoSgx/magica/blob/5e806b9/src/image/imageCompare.ts#L16)*
