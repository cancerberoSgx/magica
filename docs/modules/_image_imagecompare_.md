[magica](../README.md) › ["image/imageCompare"](_image_imagecompare_.md)
...
*Defined in [image/imageCompare.ts:8](https://github.com/cancerberoSgx/magica/blob/19bf60b/src/image/imageCompare.ts#L8)*
...
*Defined in [image/imageCompare.ts:16](https://github.com/cancerberoSgx/magica/blob/19bf60b/src/image/imageCompare.ts#L16)*
