...
*Defined in [main/run.ts:25](https://github.com/cancerberoSgx/magica/blob/819ab9b/src/main/run.ts#L25)*
...
*Defined in [main/run.ts:121](https://github.com/cancerberoSgx/magica/blob/819ab9b/src/main/run.ts#L121)*
