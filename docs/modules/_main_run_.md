...
*Defined in [main/run.ts:26](https://github.com/cancerberoSgx/magica/blob/30321a6/src/main/run.ts#L26)*
...
*Defined in [main/run.ts:111](https://github.com/cancerberoSgx/magica/blob/30321a6/src/main/run.ts#L111)*
