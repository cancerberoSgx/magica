...
async function setOverlayVisibility(v:boolean) {
  // overlayElementVisible = v;
  await toggleOverlayElementVisibility(v);
}
...
// let  overlayElementVisible=true
function Test3(){
  return (<>
  <div id="box1">
    {/* <label htmlFor=""><input type="checkbox" checked={overlayElementVisible} onChange={e=>
    setOverlayVisibility(e.currentTarget.checked)
    }/>permanent canvas</label> */}
    <button className="button is-info" onClick={async e=>{
...
// /*# sourceMappingURL=/main.186cb047.css.map */`